...
class Aplicacao(object):
    ...
    def mapearRotas(self, configurador):
        ...
        configurador.add_route(name='frutas', pattern='/frutas')
        configurador.add_route(name='fruta', pattern='/frutas/{id}')
...
@view_defaults(route_name='frutas')
class Frutas(object):
    
    def __init__(self, request):
        self.requisicao = request
        self.frutas = Listas.lista_frutas['frutas']
        
    @view_config(request_method='GET')
    def listar(self):

        return Response('listar frutas')

    @view_config(route_name='fruta', request_method='GET')
    def pegar(self):

        return Response('pegar frutas')
    
    @view_config(request_method='POST')
    def adicionar(self):

        return Response('adicionar frutas')
    
    @view_config(route_name='fruta', request_method='PUT')
    def atualizar(self):
        
        return Response('atualizar frutas')

    @view_config(route_name='fruta', request_method='DELETE')
    def deletar(self):

        return Response('deletar frutas')
